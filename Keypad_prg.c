...
void Keypad_vidInit(void)
{
	...
	Dio_vidSetPinDir(KEYPAD_u8R5_PIN , DIO_u8OUTPUT);
	...
	Dio_vidSetPinval(KEYPAD_u8R5_PIN , DIO_u8HIGH);
...
u8 Keypad_u8GetKey(void)
{
	...
	Dio_vidSetPinval(KEYPAD_u8R3_PIN , DIO_u8HIGH);
	Dio_vidSetPinval(KEYPAD_u8R4_PIN , DIO_u8HIGH);
	Dio_vidSetPinval(KEYPAD_u8R5_PIN , DIO_u8LOW);
	...
	{
		case 0b11100000:
			return KEYPAD_u8R5C1_KEY;
		case 0b11010000:
			return KEYPAD_u8R5C2_KEY;
		case 0b10110000:
			return KEYPAD_u8R5C3_KEY;
		case 0b01110000:
			return KEYPAD_u8R5C4_KEY;
	}
